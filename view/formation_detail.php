                ...
                <div class="container">
                    <div class="row text-center">
                        <div style="margin: 50px 0;" class="col-sm-12">
                            <hr><h3>Espace commentaires</h3><hr>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <strong><?= $get_comment['login']; ?></strong> <span
                                                        class="text-muted">il y a 5 jours</span>
                                            </div>
                        ...
                        <div class="col-md-6 col-md-offset-3 comment-formation">
                            <div class="widget-area no-padding blank">
                                <div class="status-upload">
                                    <div>
                                        <textarea id="comment-text" style="min-height: 100px; max-height: 100px" placeholder="Ecrivez votre commentaire ici !" ></textarea>

                                        <button id="comment-button" value="<?= $_GET['id']; ?>" class="btn btn-primary" onclick="javascript:eraseText();"><i class="fa fa-share"></i> Partager</button>
                                    </div>
                                </div>
                            </div>
                        </div>
