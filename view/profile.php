                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-9">
                                <table class="table table-user-information">
                                    ...
                                    <tr>
                                        <td>Prénom / Nom</td>
                                        <td><input id="first-name-change" name="first-name"
                                                   value="<?= $_SESSION['prenom'] ?>"> <input id="last-name-change"
                                                                                              name="last-name"
                                                                                              value="<?= $_SESSION['nom'] ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Email</td>
                                        <td><input id="email-change" name="email" value="<?= $_SESSION['email']; ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            <img class="center-block"
                                                 style="border-radius: 50px; border: 3px solid dimgrey; margin-top: 55px;"
                                                 alt="" src="images/avatar/<?= $equipe['image']; ?>">
                                        </div>
                                        <div class="col-sm-6 col-md-8">
                                            ...
                                            <p>
                                                ...
                                                <i class="fa fa-calendar-check-o"
                                                   aria-hidden="true"></i> <?= "Membre depuis le " . $equipe['inscription_d'] . ""; ?>
                                            </p>
                                            <!-- Split button -->
                                            <button data-id="<?= $equipe['id_s']; ?>" type="button"
                                                    class="newChat btn btn-primary"><i class="fa fa-comments-o"
                                                                                       aria-hidden="true"></i> Message
                                            </button>
                                        </div>
                                    </div>
                                </div>
